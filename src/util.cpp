...
const char * const BITCOIN_CONF_FILENAME = "phloxcoin.conf";
const char * const BITCOIN_PID_FILENAME = "phloxcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Phloxcoin";
#else
    // Unix
