...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/phloxcoin-project/phloxcoin>";
    const std::string URL_WEBSITE = "<https://phloxcoin.org>";
