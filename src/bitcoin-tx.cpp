...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s phloxcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  phloxcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded phloxcoin transaction") + "\n" +
              "  phloxcoin-tx [options] -create [commands]   " + _("Create hex-encoded phloxcoin transaction") + "\n" +
              "\n";
