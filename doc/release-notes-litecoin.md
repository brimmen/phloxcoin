Phloxcoin Core version *0.15.1* is now available from:

  <https://download.phloxcoin.org/phloxcoin-0.15.1/>
...
A number of changes to the way Phloxcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 Jubilees per kB (0.00001 PHLOX). This is to prepare for dropping the minimum transaction fee to 0.1 Jubilees per kB (0.0001 PHLOX) in the next release.
